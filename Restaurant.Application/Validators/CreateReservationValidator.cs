...
public class CreateReservationValidator : AbstractValidator<CreateReservationDto>
{
    public CreateReservationValidator()
    {
        ...
        RuleFor(x => x.ReservationDate).GreaterThan(DateTime.Now).WithMessage("Tarix keçmiş ola bilməz.")
            .LessThan(DateTime.Now.AddDays(90)).WithMessage("Maksimum 90 gün sonraya rezervasiya edilə bilər.");
